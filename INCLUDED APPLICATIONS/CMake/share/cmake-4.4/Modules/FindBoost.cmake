...
function(_Boost_COMPONENT_DEPENDENCIES component _ret)
  ...
  if(Boost_VERSION_STRING)
    ...
    elseif(Boost_VERSION_STRING VERSION_LESS 1.88.0)
      ...
      set(_Boost_WAVE_DEPENDENCIES filesystem serialization thread chrono atomic)
      set(_Boost_WSERIALIZATION_DEPENDENCIES serialization)
    elseif(Boost_VERSION_STRING VERSION_LESS 1.91.0)
      set(_Boost_COBALT_DEPENDENCIES cobalt_io cobalt_io_ssl container context)
      set(_Boost_CONTRACT_DEPENDENCIES thread chrono)
      set(_Boost_COROUTINE_DEPENDENCIES context)
      set(_Boost_FIBER_DEPENDENCIES context)
      set(_Boost_IOSTREAMS_DEPENDENCIES regex)
      ...
      set(_Boost_FIBER_DEPENDENCIES context)
      set(_Boost_JSON_DEPENDENCIES container)
      set(_Boost_LOG_DEPENDENCIES log_setup filesystem thread atomic)
      set(_Boost_MATH_DEPENDENCIES math_c99 math_c99f math_c99l math_tr1 math_tr1f math_tr1l)
      set(_Boost_MPI_DEPENDENCIES serialization)
      set(_Boost_MPI_PYTHON_DEPENDENCIES python${component_python_version} mpi serialization)
      set(_Boost_NUMPY_DEPENDENCIES python${component_python_version})
      ...
      set(_Boost_WAVE_DEPENDENCIES filesystem serialization thread chrono atomic)
      set(_Boost_WSERIALIZATION_DEPENDENCIES serialization)
      if(Boost_VERSION_STRING VERSION_GREATER_EQUAL 1.92.0 AND NOT Boost_NO_WARN_NEW_VERSIONS)
...
if(Boost_FIND_VERSION_EXACT)
  ...
  set(_Boost_KNOWN_VERSIONS ${Boost_ADDITIONAL_VERSIONS}
    "1.91.0" "1.91" "1.90.0" "1.90" "1.89.0" "1.89"
