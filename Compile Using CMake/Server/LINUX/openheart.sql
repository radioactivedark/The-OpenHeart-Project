...
--
-- The name below (`openheart`) must match the first line of your
-- `db` config file. To use a different name, replace `openheart`
-- in BOTH lines below.

CREATE DATABASE IF NOT EXISTS `openheart` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `openheart`;
